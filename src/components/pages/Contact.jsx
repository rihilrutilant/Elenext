      ...
      <div className="container-fluid">
        ...
        <section className="c_information">
          <div className="c_info">
            <div className="c_info_header">Contact Information</div>
            ...
            <div className="c_cards">
              ...
              <div className="c_sub_cards">
                <img
                  className="c_img"
                  src={require("../Images/contact2.png")}
                  alt="first"
                />
              ...
              <div className="c_sub_cards">
                <img
                  className="c_img"
                  src={require("../Images/contact3.png")}
                  alt="first"
                />
              ...
              <div className="c_sub_cards">
                <img
                  className="c_img"
                  src={require("../Images/contact4.png")}
                  alt="first"
                />
        ...
        <section className="send_dm">
          <div className="asks">
            <div className="asks_header">People Usually ask These</div>
              ...
              >
                <div className="accordion-item acco_item">
                  <h2 className="accordion-header">
                    <button
                      className="accordion-button acco_header"
                      type="button"
                  ...
                  >
                    <div className="accordion-body dm_body">
                      ...
                      venenatis rhoncus dolor lectus Dia aecenas ultricies mi
                      eget mauris. Nibh tellus rhoncus dolormolestie nunc
                      ultrices eros in cursus rhoncus dolorturpis massa
                      tincidunt. Ante in nibh mauri lectus. Etiam novh im lacus
                ...
                <div className="accordion-item acco_item">
                  <h2 className="accordion-header">
                    <button
                      className="accordion-button collapsed acco_header"
                      type="button"
                      data-bs-toggle="collapse"
          ...
          <div className="dm_us">
            <div className="asks_header">Send Us a Message</div>
            <div className="asks_body">
              <form action="#">
                <div className="asks_boxes">
                  <label className="asks_labels" htmlFor="y_Name">
                    Your Name
                  </label>
