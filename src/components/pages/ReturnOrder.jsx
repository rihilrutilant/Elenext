    ...
    return (
        <>
            <div className="container-fluid">
                ...
                <div className="this-order">
                    <div className="this-order-left">
                        <span>!</span>
                        <p>This order has been cancelled </p>
                    </div>
                    <div className="this-order-right">
                        <Link className='continue-shopping' to='/'>Continue Shopping</Link>
                    </div>
                </div>

                <div className="main-randrorder1">
                ...
                <div className="middle-part">
                    <p>Return Product</p>
                    <h6>Your return is complete.&nbsp;<span>When will I get my refund?</span></h6>
