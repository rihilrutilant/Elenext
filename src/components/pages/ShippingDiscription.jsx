    ...
    <>
      <div className="container-fluid">
        <div className="payment_disc">
          ...
          <div className="pd_q">What are the delivery charges?</div>
          <p className="pd_ans">Delivery charge varies with each Seller.</p>
          <p className="pd_ans">
          ...
          <p className="pd_ans">
            For Products listed as Elenext Plus, a Rs 40 charge for delivery per
          ...
          <div className="pd_q">What is the estimated delivery time?</div>
          <p className="pd_ans">
          ...
          <p className="pd_ans">
            There are NO hidden charges when you make a purchase on Elenext.
          ...
          <div className="pd_q">'In Stock'</div>
          <p className="pd_ans">
          ...
          <div className="pd_q">'Available'</div>
          <p className="pd_ans">
          ...
          <div className="pd_q">'Preorder' or 'Forthcoming'</div>
          <p className="pd_ans">
          ...
          <div className="pd_q">'Back In Stock Soon'</div>
          <p className="pd_ans">
          ...
          <div className="pd_q">'Temporarily Unavailable'</div>
          <p className="pd_ans">
          ...
          <div className="pd_q">'Permanently Discontinued'</div>
          <p className="pd_ans">
          ...
          <p className="pd_ans">
            As of now, Elenext doesn't deliver items internationally.
          </p>
          <p className="pd_ans">
