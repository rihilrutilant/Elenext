        ...
        <>
            <div className="container-fluid">
                <div className="payment_disc">
                    <div className="pd_q">Updated June 3rd, 2022</div>
                    <div className="pd_header" style={{ textAlign: "center" }}>PRIVACY POLICY</div>
                    <p className="pd_ans">
                        We value the trust you place in us and recognize the importance of secure transactions and information privacy. This Privacy Policy describes how Elenext Internet Private Limited and its affiliates (collectively “Elenext, we, our, us”) collect, use, share or otherwise process your personal information through Elenext website www.Elenext.com, its mobile application, and m-site (hereinafter referred to as the “Platform”).
                    </p>
                    <p className="pd_ans">
                    ...
                    <div className="pd_q">Collection of Your Information</div>
                    <p className="pd_ans">
                    ...
                    <p className="pd_ans">
                        If you enrol into our SuperCoins Loyalty Program or similar programs offered by Elenext, we will collect and store your personal information such as name, contact number, email address, communication address, date of birth, gender, zip code, lifestyle information, demographic and work details which is provided by you to Elenext or a third-party business partner that operates online/offline establishments or platforms where you can earn SuperCoins for purchase of goods and services, and redeem SuperCoins. We will also collect your information related to your transactions on Elenext platform and such third-party business partner platforms. When such third-party business partner collects your personal information directly from you, you will be governed by their privacy policies. Elenext shall not be responsible for the third-party business partner’s privacy practices or the content of their privacy policies, and we request you to read their privacy policies prior to disclosing any information.
                    </p>
                    <p className="pd_ans">
                        Elenext has onboarded certain third-party business partners on the Platform who specialise in the categories like travel ticket reservations, booking online movie tickets, paying online bills and more (Ultra-Partners). If you use the services of Ultra-Partners, you will be redirected to Ultra-Partners websites/applications and your entry to Ultra-Partners websites/applications will be based on your Elenext login credentials after seeking your permissions to share the data further. Elenext shall not be responsible for the Ultra-Partner’s privacy practices or the content of their privacy policies, and we request you to read their privacy policies prior to disclosing any information.
                    </p>
                    <div className="pd_q">Use of Demographic / Profile Data / Your Information</div>
                    <p className="pd_ans">
                    ...
                    <p className="pd_ans">
                        We may share personal information internally within Elenext group companies, affiliates, related companies and with other third parties for purposes of providing products and services offered by them, such as, the deferred payment options Elenext PayLater offered by Elenext Advanz Private Limited through its lending partners. These entities and affiliates may share such information with their affiliates, business partners and other third parties for the purpose of providing you their products and services and may market to you as a result of such sharing unless you explicitly opt-out.
                    </p>
                    <p className="pd_ans">
                    ...
                    <p className="pd_ans">
                        We provide all users with the opportunity to opt-out of receiving non-essential (promotional, marketing-related) communications after setting up an account with us. If you do not wish to receive promotional communications from us, then please login into the Notification Preference page of Platform [https://www.Elenext.com/communication-preferences/email] to unsubscribe/opt-out.
                    </p>
                    <div className="pd_q">
                        Advertisements on Platform
                    </div>
                    <p className="pd_ans">
                        We use third-party advertising companies to serve ads when you visit our Platform. These companies may use information (not including your name, address, email address, or telephone number) about your visits to this and other websites in order to provide advertisements about goods and services of interest to you.You have an option to opt out from tracking of personalized advertising using the “Opt out of Ads Personalization” settings using your device’s settings application. Elenext will have no access to your GAID once you select this feature.
                    </p>
                    <div className="pd_q">
                    ...
                    <p className="pd_ans">In accordance with Information Technology Act 2000 and rules made there under, the name and contact details of the Grievance Officer are provided below:</p>
                    <p className="pd_ans">Mr. ANIL  CHOTIYA</p>
                    <p className="pd_ans">Designation: Senior Manager</p>
                    <p className="pd_ans">Rutilant technology,</p>
                    <p className="pd_ans">2th Floor 230 Antlanta shoping</p>
                    <p className="pd_ans">Mota varacha sodama chok,</p>
                    <p className="pd_ans">Varthur Hobli, Bengaluru East Taluk,</p>
                    <p className="pd_ans">Surat : 395001, India</p>
                    <p className="pd_ans">contact us</p>
                    <p className="pd_ans">Email: grievance.officer@elenext.com</p>
                    <p className="pd_ans">Phone: 1800 202 9898</p>
                    <p className="pd_ans">Time: Mon - Sat (9:00 - 18:00)</p>
                    <div className="pd_q">
                        Grievance Officer
                    </div>
                    <p className="pd_ans">
                        You can reach our customer support team to address any of your queries or complaints related to product and services by clicking the link, selecting your order and choosing 'Need Help' option: https://www.Elenext.com/helpcentre
                    </p>
                    <div className="pd_q">
                        Queries related to Privacy Policy
                    </div>
                    <p className="pd_ans">
                        If you have a query, concern, or complaint in relation to collection or usage of your personal information under this Privacy Policy, please contact us at privacy.grievance@Elenext.com.
                    </p>
                    <div className="pd_q">
