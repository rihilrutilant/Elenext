        ...
        <>
            <div className="container-fluid">
                <div className="payment_disc">
                    ...
                    <div className="pd_q" style={{ fontSize: "24px" }}>
                        Elenext Terms of Use
                    </div>
                    <p className="pd_ans" style={{ padding: "10px 0" }}>
                        This document is an electronic record in terms of Information Technology Act, 2000 and rules there under as applicable and the amended provisions pertaining to electronic records in various statutes as amended by the Information Technology Act, 2000. This electronic record is generated by a computer system and does not require any physical or digital signatures.
                    </p>
                    <p className="pd_ans" style={{ padding: "10px 0" }}>
                        This document is published in accordance with the provisions of Rule 3 (1) of the Information Technology (Intermediaries guidelines) Rules, 2011 that require publishing the rules and regulations, privacy policy and Terms of Use for access or usage of domain name [www.Elenext.com][www.Elenext.com] (“Website”), including the related mobile site and mobile application (hereinafter referred to as “Platform”)
                    </p>
                    <p className="pd_ans" style={{ padding: "10px 0" }}>
                        The Platform is owned by Elenext Internet Private Limited a company incorporated under the Companies Act, 1956 with its registered office at Buildings Alyssa, Begonia & Clover, Embassy Tech Village, Outer Ring Road, Devarabeesanahalli Village, Bengaluru – 560103, Karnataka, India and its branch offices at 2nd Floor, Block F (Flora), Embassy Tech Village, Outer Ring Road, Devarabeesanahalli Village, Bengaluru-560103, Karnataka, India and; 447/C, 12th Main, 4th Block, Koramangala, Bengaluru-560034, Karnataka, India (hereinafter referred to as "Elenext").
                    </p>
                    <p className="pd_ans" style={{ padding: "10px 0" }}>
                    ...
                    <p className="pd_ans" style={{ padding: "10px 0" }}></p>
                    <p className="pd_ans" style={{ padding: "10px 0" }}></p>
                    <p className="pd_ans" style={{ padding: "10px 0" }}></p>
                    <ul className='pd_list'>
                        <li className="pd_ans"></li>
